...
import algos.miu.sorts.src.util.RandomPermutations;
import algos.miu.sorts.src.util.Util;

import java.util.*;


public class SortTester {
	private final String PACKAGE = "algos.miu.sorts.src.sortroutines";
	private final String FILENAME = "src/algos/miu/sorts/sorters_to_be_run.txt";
