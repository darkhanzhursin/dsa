...
import miu.mpp.exam_banking.accounts.CheckingAccount;
import miu.mpp.exam_banking.accounts.SavingsAccount;
...
public class Main {
	public static void main(String[] args) {
        ...
        System.out.printf("$%,3.2f", Admin.computeUpdatedBalanceSum(employees));
