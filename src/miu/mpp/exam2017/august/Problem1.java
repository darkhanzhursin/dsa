package miu.mpp.exam2017.august;
...
public class Problem1 {
	...
	private static void testSecondMethod() {
		...
		Customer cust8 = new Customer("Tom", "211 Blake Ave", "Washington", "52672");
		List<Customer> list = Arrays.asList(cust1, cust2, cust3, cust4, cust5, cust6, cust7, cust8);
