...
import patterns.creational.builder.model.CarBuilder;
import patterns.creational.builder.model.CarSchemaBuilder;

/*
* Builder is a creational design pattern, which allows constructing complex objects step by step. The Builder Pattern
...
* builder object that is to be used to generate the product. The director then calls methods of the concrete builder
* in the correct order to generate the product object. On completion of the process, the GetProduct method of the
